...
def main():
    ...
    df_mt = pd.read_parquet("/projectnb/rlhf/mingyuc/verl_github/verl/data/maze_mt/train50000.parquet")
    ...
    train_data = conversations[:10000] # First 2 conversations for training
