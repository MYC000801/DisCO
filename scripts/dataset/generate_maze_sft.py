...
parser.add_argument("--save_path", type=str, default='/projectnb/rlhf/mingyuc/verl_github/verl/data/maze_mt/train100000.parquet', help="Path to save the generated parquet file.")
...
for i in tqdm(range(NUM_SAMPLES), desc="Generating mazes"):
    ...
    msg = build_multi_trajectory_chat_history(maze, start, goal, K=TRAJ_PER_CHAT, N=STEP_PER_TRAJ)
    if msg[-1]['content'] == "Arrive the goal! Let's try again.":
        msgs.append(msg)
